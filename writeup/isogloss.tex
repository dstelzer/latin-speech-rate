...
% Changed: add raggedbottom
\raggedbottom
% Force gb4e examples leftward
\exewidth{(2)}
...
\setcounter{exx}{3} % Make the numbers be the same between examples and equations: we had three equations above, so now the first example should be 4
...
\setcounter{equation}{7} % This is horribly hacky but it's the last stages of copy-editing and I don't really want to go edit gb4e to make it use the equation counter
...
\setcounter{exx}{10} % And one final awful hack
